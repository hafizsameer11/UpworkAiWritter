                ...
                <div class="card-body ">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <a href="{{route('niches.create')}}" class="btn btn-primary mr-2">
                                Add Niche
                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-4">
                                                <a href="{{route('niches.show',$niche->id)}}" class="btn">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                <a href="{{route('niches.edit', $niche->id)}}" class="btn">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <button class="btn delete_Btn" data-id="{{$niche->id}}"
